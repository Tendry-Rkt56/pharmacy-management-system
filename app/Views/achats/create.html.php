        ...
        <form id="saleForm" method="POST" action="">
            <div id="medicamentContainer">
                <div class="medicament-group">
                    <input class="premier" type="text" class="medicament" placeholder="Nom du médicament">
                    <input class="premier-1" type="number" class="prix" placeholder="Prix" readonly>
                    <input class="premier-2" type="number" class="nombre" placeholder="Nombre">
