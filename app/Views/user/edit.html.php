     ...
     <div class="registration container">
          <div class="wrapper">
               ...
               <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container-fluid row">
                         <div class="col-6 input-box">
                              <input type="text" value="<?=$user->telephone?>" placeholder="Téléphone..." class="form-control" name="telephone">
                         </div>
                         <div class="col-6 input-box">
                              <input type="text" name="adresse" value="<?=$user->adresse?>" placeholder="Adresse...">
                         </div>
                    </div>
                    <div class="container-fluid row">
